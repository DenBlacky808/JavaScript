...
//добавил wallCell и score, нужно доставить wallPoint, score
    render(snakePointsArray, foodPoint, wallPoint, score) {
...
//метод получения score

    getScore() {
       return this.snake.getBody().length - 1
    },

//отдал координаты стены и score
    render() {
        this.map.render(this.snake.getBody(), this.food.getCoordinates(),
            this.wall.getCoordinates(), this.getScore());
    },
};
